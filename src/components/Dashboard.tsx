...
export default function Dashboard() {
  ...
  return (
    <div className="flex min-h-screen globalBackground">
            ...
            <div className="p-8">
              <div className="flex items-center justify-between px-4 py-3">
                <div className="flex items-center">
                  <CiSettings className="text-white mr-5 w-9 h-9" />
                  <span 
      ...
      {modalInfo && (
        <div id="default-modal" className="fixed inset-0 z-50 flex backdrop-blur items-center justify-center bg-black bg-opacity-50">
          <div className="relative w-full max-w-7xl h-5/6 glassCard3 p-7"> 
      ...
      {showAllResumes && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black backdrop-blur bg-opacity-50">
          <div className="relative w-full max-w-4xl h-[80vh] glassCard3 p-7 flex flex-col">
            <div className="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
            ...
            <div className="flex-grow overflow-y-auto p-4 md:p-5 no-scrollbar">
